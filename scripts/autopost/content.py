...
def build_weekly_horoscope_post_fallback() -> str:
    ...
    intro_lines = [
        "Энэ долоо хоногт харилцаа, мөнгө санхүү, ажлын хэмнэл дээрээ няхуур байх ордууд олон байна. Яаруу шийдвэрээс илүү тогтвортой алхам илүү үр дүнтэй байх төлөв ажиглагдана.",
        "7 хоногийн ерөнхий урсгал нь дотоод төвлөрөл, ойрын хүмүүстэйгээ ойлголцох байдал, мөнгө санхүүгээ хянах тал руу илүү анхаарахыг сануулж байна.",
        "Энэ долоо хоногт ихэнх ордуудад харилцаа, хариуцлага, санхүүгийн сахилга хамгийн чухал сэдэв болж гарч ирнэ.",
    ]
    area_lines = [
        "ажил хэрэг ба нэр хүнд дээрээ",
        "мөнгө санхүү, зарлага дээрээ",
        "гэр бүл, ойрын хүмүүстэйгээ",
        "эрч хүч, амралтын хэмнэл дээрээ",
        "шинэ санаа, урт хугацааны зорилгодоо",
        "харилцаа, хамтын ажиллагаандаа",
    ]
    action_lines = [
        "хийж эхэлсэн ажлаа дуусгаж, илүү дутуу амлалт өгөхөөс зайлсхийвэл сайн.",
        "бага зэрэг удааширсан ч чиглэлээ алдахгүй байвал долоо хоногийн сүүлээр үр дүн гарна.",
        "сэтгэл хөдлөлөөр бус бодит нөхцөлдөө тулгуурлан алхвал амар байна.",
        "ойрын хүмүүстэйгээ зөөлөн ярилцаж, үл ойлголцлыг хурдан тайлах нь ашигтай.",
        "хэт ачаалал авахгүй, хийх ажлаа эрэмбэлж явбал тогтуун өнгөрнө.",
        "боломж гарсан үед шинэ санаагаа сорих ч эрсдлээ урьдчилж тооцоолох хэрэгтэй.",
    ]
    closing_lines = [
        "Долоо хоногийн төгсгөлд тайван амралт авч чадвал дараагийн алхам тодорно.",
        "Яаруу зангаа барьж чадвал энэ 7 хоногийн ихэнх сорилтыг зөөллөх боломжтой.",
        "Ойрын хүмүүсийн зөвлөгөөг сонсох нь энэ долоо хоногийн хамгийн зөв алхам болно.",
    ]

    lines = [
        f"7 хоногийн 12 ордын зурхай ({monday.strftime('%Y.%m.%d')}-{sunday.strftime('%Y.%m.%d')})",
        "",
        intro_lines[seed % len(intro_lines)],
        "",
    ]
    for idx, (symbol, label, date_range) in enumerate(ZODIAC_SIGN_DETAILS_MN):
        ...
        lines.append(f"{symbol} {label} ({date_range})")
        lines.append(
            f"Энэ долоо хоногт {area} илүү няхуур хандвал ашигтай. {action} {closing}"
        )
        lines.append("")
    lines.extend(
        [
            "Тэмдэглэл: Энэ нь 7 хоногийн ерөнхий ордын зурхай бөгөөд хувь хүний нөхцөлөөс хамаарч өөр байна.",
            "#7ХоногийнЗурхай #12Орд #ОрдныЗурхай #DigitalLam",
        ]
    )
    return "\n".join(lines).strip()
